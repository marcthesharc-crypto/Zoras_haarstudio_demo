...
const services = [
  {
    icon: Scissors,
    title: 'Herren-Haarschnitt mit Waschen',
    description: 'Professioneller Schnitt inklusive Haare waschen und Kopfmassage',
    price: 'ab €45',
    className: 'col-span-1 md:col-span-4 border-b md:border-r',
  },
  {
    icon: Sparkles,
    title: 'Herren-Haarschnitt ohne Waschen',
  ...
  },
  {
    icon: Wand2,
    title: 'Barttrim',
    description: 'Professioneller Bartschnitt',
    price: 'ab €5 Aufpreis',
  ...
  },
  {
    icon: Droplets,
    title: 'Haarprodukte',
    description: 'Haarprodukte aus unserer Kollektion - mit Empfehlung von unseren Stylisten',
    price: 'ab €15',
